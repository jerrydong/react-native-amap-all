...
public class AMapLocationReactModule extends ReactContextBaseJavaModule implements AMapLocationListener{
    ...
    private void sendEvent(String eventName,
        ...
        Log.w("Send Event", "eventName" + eventName );
        Log.w("Send Event", "params" + params );
        Log.w("Send Event", "mReactContext" + mReactContext );
    ...
    public void startLocation(@Nullable ReadableMap options) {
      try{
        ...
        //启动定位
        this.mLocationClient.startLocation();
        Log.w("starfire", "finish start location");
      }catch(Exception e) {
        Log.e("starfire", "startLocation error!!!!!!!!!!!!!!!");
      }
    }
    ...
    */
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        Log.w("starfire", "location changed" + amapLocation);
